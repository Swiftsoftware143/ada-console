...
import { Mail, Save, Eye, Code, Type, RefreshCw, TestTube } from "lucide-react";
...
export default function EmailTemplates() {
  ...
  const [fromEmail, setFromEmail] = useState("hello@swiftimpactsolutions.com");
  const [fromName, setFromName] = useState("SwiftImpact Solutions");
  ...
  const insertVariable = (variable) => {
    // Determine which textarea is active based on current tab
    ...
    if (activeElement && activeElement.tagName === "TEXTAREA") {
      ...
      // If no textarea is focused, insert into HTML template by default
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex gap-3">
            <Button onClick={handleSave} disabled={saving} className="bg-[#007bff]">
              <Save className="h-4 w-4 mr-2" />
              {saving ? "Saving..." : "Save Templates"}
            </Button>
            <Button onClick={handleReset} variant="outline" className="border-[#2e3245] text-[#94a3b8]">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setPreviewData({...previewData, domain: e.target.value})}
                  placeholder="Domain"
                  className="bg-[#0f1117] border-[#2e3245] text-white text-sm"
                />
              </div>
