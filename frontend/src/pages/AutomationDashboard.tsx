...
export default function AutomationDashboard(): JSX.Element {
  ...
  const saveEmailTemplate = async (): Promise<void> => {
    try {
      await supabase.from('settings').upsert({
        key: 'email_template',
  ...
  const toggleAutomation = async (enabled: boolean): Promise<void> => {
    try {
      await supabase.from('settings').upsert({
  ...
  const getStatusIcon = (status: string, errorMessage?: string): JSX.Element => {
            ...
            <div className="space-y-3">
              {recentLogs.map((log) => (
                <div key={log.id} className="flex items-center justify-between p-3 bg-[#0f1117] rounded-lg border border-[#2e3245]">
                  <div className="flex items-center gap-3">
                    {getStatusIcon(log.email_status, log.error_message)}
                    <div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, smtpHost: e.target.value })}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, smtpPort: e.target.value })}
                  placeholder="587"
                  className="bg-[#0f1117] border-[#2e3245] text-white"
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, smtpUser: e.target.value })}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, smtpPass: e.target.value })}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, fromEmail: e.target.value })}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, fromName: e.target.value })}
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setEmailTemplate({ ...emailTemplate, subject: e.target.value })}
                    className="bg-[#0f1117] border-[#2e3245] text-white"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={(e: ChangeEvent<HTMLTextAreaElement>) => setEmailTemplate({ ...emailTemplate, htmlBody: e.target.value })}
                  ...
                  <div className="p-3 bg-[#0f1117] rounded-lg border border-[#2e3245]">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Input
                        ...
                        onChange={(e: ChangeEvent<HTMLInputElement>) => setPreviewData({ ...previewData, contact_name: e.target.value })}
                        placeholder="Contact Name"
                        className="bg-[#1e2130] border-[#2e3245] text-white text-sm"
                      />
                      <Input
                        value={previewData.company_name}
                        onChange={(e: ChangeEvent<HTMLInputElement>) => setPreviewData({ ...previewData, company_name: e.target.value })}
