...
import { ClientFormModalProps, Client } from "@/types";
...
const ClientFormModal: React.FC<ClientFormModalProps> = ({ open, onOpenChange, onCreated, isPersonal = false }) => {
  ...
  const addTagsToSettings = async (newTags: string[]): Promise<void> => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v: 'basic' | 'starter' | 'pro' | 'growth' | 'enterprise') => setForm({ ...form, plan_tier: v })}
            >
              <SelectTrigger
