...
import { PersonalWebsiteFormModalProps, PersonalWebsite } from "@/types";
...
const PersonalWebsiteFormModal: React.FC<PersonalWebsiteFormModalProps> = ({ open, onOpenChange, onCreated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    onCreated?.(data?.[0] as PersonalWebsite);
    onOpenChange(false);
  };
      ...
      <DialogContent className="bg-[#1e2130] border border-[#2e3245] text-white sm:max-w-[480px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Select value={form.plan_tier} onValueChange={(v: 'basic' | 'starter' | 'pro' | 'growth' | 'enterprise') => setForm({ ...form, plan_tier: v })}>
...
export default PersonalWebsiteFormModal;
