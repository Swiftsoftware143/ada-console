...
import { LayoutDashboard, Users, Code2, Settings, Globe, Puzzle, LogOut, User, Layers, Workflow, Scan, Mail, LucideIcon } from "lucide-react";
          ...
          <NavLink
            ...
            className={({ isActive }: { isActive: boolean }) =>
              `group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ${
                isActive
                  ? "bg-[#007bff]/12 text-white border border-[#007bff]/30 shadow-lg shadow-[#007bff]/10"
        ...
        <NavLink
          ...
          className={({ isActive }: { isActive: boolean }) =>
            `group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 mb-2 ${
              isActive
                ? "bg-[#007bff]/10 text-white border border-[#007bff]/30 shadow-lg shadow-[#007bff]/10"
                : "text-[#94a3b8] hover:text-white hover:bg-white/5 border border-transparent"
            }`
          }
        >
